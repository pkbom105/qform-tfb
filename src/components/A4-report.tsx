        ...
        return (
          ...
          >
                ...
                <div className="flex flex-wrap gap-3">
                  {design_images.map((img: string, idx: number) => (
                    <a
                      ...
                      className="w-24 h-24 border border-slate-200 rounded-lg overflow-hidden bg-white shadow-sm flex-shrink-0"
                    >
                      <img
                        src={img}
                        alt={`Attached ${idx}`}
            ...
            <div className="mt-auto pt-8 border-t border-slate-100 flex justify-between items-end">
              <div className="text-sm font-light text-black uppercase">
                {customer_profile.company || "-"}
              </div>
              <div className="text-[8px] text-black italic">
